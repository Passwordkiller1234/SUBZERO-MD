...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~0HkcMMHbOe2zsW6oNgku",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "233540190963",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Mr Frank",           // Owner's name
    DEV: process.env.DEV || "233540190963",                     // Developer's contact number
    DEVELOPER_NUMBER: '233540190963@s.whatsapp.net',            // Developer's WhatsApp ID
